    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<RidesRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final successRidesRecord = snapshot.data!;
                ...
                actions: [
                  Padding(
                    ...
                    child: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        if (successRidesRecord.reservation) {
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Ridelia — Luxury rides affordable rates',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                ...
                                onPressed: () async {
                                  if ((_model.rating != null) ||
                                    ...
                                    if (valueOrDefault<bool>(
                                      ...
                                      await successRidesRecord.customer!
                                          .update({
                                        ...mapToFirestore(
                                          {
                                            'ratingsGiven':
                                      ...
                                      await successRidesRecord.driver!.update({
                                        ...mapToFirestore(
                                          {
                                            'ratingsGiven':
                                                FieldValue.arrayUnion([
