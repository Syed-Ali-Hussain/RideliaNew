...
import 'schema/airports_record.dart';
import 'schema/waitlist_record.dart';
import 'schema/charges_record.dart';
...
export 'schema/airports_record.dart';
export 'schema/waitlist_record.dart';
export 'schema/charges_record.dart';
...
/// Functions to query AirportsRecords (as a Stream and as a Future).
Future<int> queryAirportsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AirportsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AirportsRecord>> queryAirportsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AirportsRecord.collection,
      AirportsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AirportsRecord>> queryAirportsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryWaitlistRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      WaitlistRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
/// Functions to query ChargesRecords (as a Stream and as a Future).
Future<int> queryChargesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ChargesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ChargesRecord>> queryChargesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ChargesRecord.collection,
      ChargesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ChargesRecord>> queryChargesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
