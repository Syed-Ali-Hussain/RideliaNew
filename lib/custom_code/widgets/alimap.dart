...
class _AlimapState extends State<Alimap> {
  ...
  Future<void> _createRoute() async {
    ...
    final url =
        "https://maps.googleapis.com/maps/api/directions/json?origin=$origin&destination=$destination$waypoints&key=${widget.apiKey}";
  ...
  void _onMapCreated(gmaps.GoogleMapController controller) {
    ...
    // Apply the custom map theme if provided
    if (widget.mapThemeString != null) {
      controller.setMapStyle(widget.mapThemeString);
    }
