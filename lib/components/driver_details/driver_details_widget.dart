  ...
  Widget build(BuildContext context) {
    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<RidesRecord>(
        stream: RidesRecord.getDocument(currentUserDocument!.rideGoingOn!),
        builder: (context, snapshot) {
          ...
          return Container(
            ...
            child: FutureBuilder<UsersRecord>(
              future: UsersRecord.getDocumentOnce(containerRidesRecord.driver!),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                if (!snapshot.hasData) {
                  return Center(
                      ...
                      children: [
                        ...
                        wrapWithModel(
                          ...
                          child: UserInfoWidget(
                            ...
                            rideDoc: currentUserDocument!.rideGoingOn!,
                          ),
                        ),
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  RichText(
                                    ...
                                    text: TextSpan(
                                      children: [
                                        ...
                                        TextSpan(
                                          text: widget.driver!.numberPlate,
                                          style: GoogleFonts.montserrat(),
                                        )
                                      ],
                                      style: FlutterFlowTheme.of(context)
