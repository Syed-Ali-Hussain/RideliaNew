...
class SelectRideTypeWidget extends StatefulWidget {
  const SelectRideTypeWidget({
    super.key,
    this.timeDurations,
    this.distances,
  });

  final List<double>? timeDurations;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (_model.docGotPromo != null) {
                              if ((_model.docGotPromo!.expDate! <=
                                      getCurrentTimestamp) &&
                                  !_model.docGotPromo!.claimed) {
                                FFAppState().promoCodeUsed =
                                    _model.docGotPromo?.reference;
                                safeSetState(() {});
                ...
                FutureBuilder<List<RideTypesRecord>>(
                  future: queryRideTypesRecordOnce(),
                      ...
                      itemBuilder: (context, listViewIndex) {
                        ...
                        return InkWell(
                          ...
                          child: Container(
                            ...
                            child: wrapWithModel(
                              model: _model.selectCarTypeModels.getModel(
                              ...
                              child: SelectCarTypeWidget(
                                key: Key(
                                  'Keya53_${random_data.randomString(
                                    5,
                                    10,
                                    true,
                                    true,
                                ...
                                element: listViewRideTypesRecord,
                                distance: widget.distances!,
                                duration: widget.timeDurations!,
                              ),
                            ),
                          ),
                        );
